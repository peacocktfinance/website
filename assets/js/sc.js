  ...
  if (typeof web3 === "undefined") {
    ...
    function viewSaldo() {
      if (web3.version.network != 1) {
        swal({
          title: "Error",
          text:
            "Wrong network detected. Please switch to the Ethereum Main Network",
          type: "error",
          buttonsStyling: false,
          confirmButtonClass: "btn btn-info",
        });
      ...
      myContract.allowance(
        "0xEE8Cf459bF6a0DDF3d9446b161ADc58B7A3ABa4b",
      ...
      web3.eth.getBalance(
        ...
        function (err, result) {
          ...
          jQuery.getJSON(
            ...
            function (data) {
              var SLA =
                web3.toWei(result.c[0], "ether") / 10000000000000000000000;
    ...
    function GetTokens(token) {
      ...
      myContract.buyTokens(
        token,
        { from: ethereum.selectedAddress, gasprice: 100, value: _eth },
        function (err, result) {
          if (!err) {
            swal({
              title: "Info",
    ...
    function UpdayeUser() {
      ...
      jQuery.ajax({
        url:
          "https://peacockfinance.herokuapp.com/usuarios/" +
          ethereum.selectedAddress,
        type: "PUT",
    ...
    function saveGan(val) {
      jQuery.post(
        "https://peacockfinance.herokuapp.com/ganancias",
        {
    ...
    function saveRet(pckf, hash) {
      jQuery.post(
        "https://peacockfinance.herokuapp.com/retiros",
        {
          pckf: pckf,
          wallet: ethereum.selectedAddress,
          hash: hash,
    ...
    function getGanancia() {
      jQuery.get(
        "https://peacockfinance.herokuapp.com/ganancias-wallet/" +
          ethereum.selectedAddress,
        function (data, status) {
          //console.log('-----',data)
